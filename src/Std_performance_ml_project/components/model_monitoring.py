...
class ModelMonitoring:
    def initiate_model_training(self,X_test,y_test,actual_model,best_model,best_model_score,best_params):
        try:
            ...
            with mlflow.start_run():
                ...
                (mae,mse,rmse,r2) = self.calculate_Score_Regression(y_test, predicted_qualities)
